...
extension Recipe {
    ...
    static let screenshotMock = Recipe(
        id: nil,
        ...
        ingredients: [
            ...
            Ingredient(name: "Fresh parsley",  amount: "1",   unit: "bunch"),
    ...
    static let screenshotMockSalad = Recipe(
        id: nil,
        ...
        ingredients: [
            Ingredient(name: "Cherry tomatoes", amount: "250", unit: "g"),
            Ingredient(name: "Cucumber",        amount: "1",   unit: ""),
            Ingredient(name: "Red onion",       amount: "½",   unit: ""),
            Ingredient(name: "Kalamata olives", amount: "80",  unit: "g"),
    ...
    static let screenshotMockChicken = Recipe(
        id: nil,
        ...
        ingredients: [
            Ingredient(name: "Chicken breasts", amount: "2", unit: ""),
            ...
            Ingredient(name: "Thyme",           amount: "3", unit: "sprigs"),
